<template>
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束日期" :disabled-date="time=> searchInfo.startCreatedAt ? time.getTime() < searchInfo.startCreatedAt.getTime() : false"></el-date-picker>
        ...
        <el-form-item label="档口" prop="stalls">
         <el-input v-model="searchInfo.stalls" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="路线名称" prop="routeName" width="120" />
        <el-table-column align="left" label="备注" prop="remarks" width="120" />
        <el-table-column align="left" label="档口" prop="stalls" width="120">
          <template #default="scope">
                
                    <el-tag v-for="(item,key) in filterDataSource(dataSource.stalls,scope.row.stalls)" :key="key">
                        {{ item }}
                    </el-tag>
        ...
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
            <template #default="scope">
            <el-button type="primary" link icon="edit" class="table-button" @click="updateRouteFunc(scope.row)">变更</el-button>
...
const getTableData = async() => {
  const table = await getRouteList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
