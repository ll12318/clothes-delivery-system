  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
            ...
            <el-button type="primary" link icon="edit" class="table-button" @click="updateGoodBillFunc(scope.row)">变更</el-button>
...
const getTableData = async() => {
  const table = await getGoodBillList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
             ...
             if (!valid) return
              ...
              switch (type.value) {
                case 'create':
                  ...
                  break
                case 'update':
                  res = await updateGoodBill(formData.value)
                  break
                default:
                  res = await createGoodBill(formData.value)
                  break
